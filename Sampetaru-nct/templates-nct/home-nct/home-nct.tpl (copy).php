											...
											<ul>		
												<li  class="span1_of_1 desti1">
													 <div class="book_date">
														 <form>
															<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
															<input type="text" placeholder="From" class="typeahead1 input-md form-control tt-input" required="" id="from_city" name="from_city" name="start">
														 </form>
													 </div>					
												 </li>
												 <li  class="span1_of_1 desti1">
													 <div class="book_date">
														 <form>
															<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
															<input type="text" placeholder="To" class="typeahead1 input-md form-control tt-input" required="" name="end">
														 </form>
													 </div>					
												 </li>
												 <div class="clearfix"> </div>
										...
										<br>
											...
											<ul>	
												 <li  class="span1_of_1">
													...
													<form>
														<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
														<input class="date" id="s_datepicker1" type="text" value="<?php echo $date;?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $date;?>';}" required="">
													 </form>
													 </div>		
												 </li>
												 <li  class="span1_of_1 left">
													...
													<form>
														<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
														<input class="date" id="s_datepicker2" type="text" value="<?php echo $date;?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $date;?>';}" required="">
													 </form>
													 </div>					
												 </li>
												 <div class="clearfix"> </div>
										...
										<div class="reservation">
											<ul>
												<li class="span1_of_1 adult">
													<h5 style="padding-left: 25%;">Length(cm*)</h5>
													<div class="book_date" style="width: 95%;">
														 <form>
															<span class="glyphicon glyphicon-resize-horizontal" aria-hidden="true"></span>
															<input type="text" placeholder="From" class="typeahead1 input-md form-control tt-input" required="" id="from_city" name="from_city" name="start">
														 </form>
													 </div>
													<!-- <div style="height: 100px; width: 100px; background-image: url('{SITE_IMG}parcels.png'); border: solid;">
														<p><input type="radio" name="radio1">parcel</p>
													</div>
													<div style="height: 100px; width: 100px; background-image: url('{SITE_IMG}document.png'); border: solid;">
														<p><input type="radio" name="radio1">Document</p>
													</div> -->
												</li>
												<li class="span1_of_1 adult">
													<h5 style="padding-left: 25%;">Width(cm*)</h5>
													<div class="book_date" style="width: 95%;">
														 <form>
															<span class="glyphicon glyphicon-resize-horizontal" aria-hidden="true"></span>
															<input type="text" placeholder="From" class="typeahead1 input-md form-control tt-input" required="" id="from_city" name="from_city" name="start">
												...
												<li class="span1_of_1 adult">
													<h5 style="padding-left: 25%;">Height(cm*)</h5>
													<div class="book_date" style="width: 100%;">
														 <form>
										...
										<div class="reservation">
											<ul>	
												 <li class="span1_of_3">
														<div class="date_btn">
															<form>
																<input type="submit" value="Get Your Search" />
															</form>
														</div>
												 </li>
												 <div class="clearfix"></div>
